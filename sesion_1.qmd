---
title: "Introducción a R y Quarto"
...
- Repaso de cómo usar R y RStudio
- Creación de nuestro primer documento en Quarto
- Trabajo con datos en R
- Introducción del paquete `tidyverse` y `tidymodels`
::::

## Durante los próximos 4 días vamos a: 🚀

- 📊 Repasar cómo usar R y RStudio
- 📝 Aprender a usar Quarto
- 🔧 Aprender a usar `tidyverse` para manipulación de datos
- 🤖 Aprender a usar `tidymodels` para machine learning
...
1. Una breve introducción al proyecto.
2. Una sección de resultados que muestre el desempeño del modelo y una visualización de las predicciones del modelo.
...
- Describe o ilustra características de algunos datos.
- Sin otro propósito que enfatizar visualmente alguna tendencia o patrón en los datos.
...
- Explora una hipótesis específica: se utilizan pruebas estadísticas.

Un modelo inferencial parte de una conjetura o idea predefinida sobre una población y produce una conclusión estadística, como un intervalo de estimación o el rechazo de una hipótesis.

- Por ejemplo, el objetivo de un ensayo clínico podría ser confirmar que una nueva terapia hace un mejor trabajo prolongando la vida.
...
- Produce la predicción más precisa posible.
...
## ¿Inteligencia artificial? ¿Machine Learning? ¿Qué?
::: {.incremental}
:::: {.columns}
::: {.column width="50%"}
